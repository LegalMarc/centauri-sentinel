...
**File:** [sentinel/bot/commands.py](../sentinel/bot/commands.py)
...
**File:** [sentinel/watcher/loop.py](../sentinel/watcher/loop.py)
...
**File:** [sentinel/camera/mjpeg.py](../sentinel/camera/mjpeg.py)
...
**File:** [sentinel/ml/nonce.py](../sentinel/ml/nonce.py)
...
**File:** [sentinel/ml/client.py](../sentinel/ml/client.py)
...
### [PASS 1] [HIGH] Watcher stays ARMED when printer is paused externally
**File:** [sentinel/watcher/loop.py](../sentinel/watcher/loop.py) (lines 245–252)
...
**File:** [sentinel/web/routes.py](../sentinel/web/routes.py)
...
**File:** [sentinel/web/auth.py](../sentinel/web/auth.py)
...
**File:** [sentinel/safety.py](../sentinel/safety.py)
...
**File:** [sentinel/notify/telegram.py](../sentinel/notify/telegram.py)
...
**File:** [sentinel/bot/runner.py](../sentinel/bot/runner.py)
...
### [PASS 3] [LOW] Blocking file read of ML token on main event loop
**File:** [sentinel/ml/client.py](../sentinel/ml/client.py) (lines 94-105)
...
**File:** [sentinel/db/migrate.py](../sentinel/db/migrate.py)
...
**File:** [tests/test_watcher.py](../tests/test_watcher.py)
...
**File:** [tests/test_bot.py](../tests/test_bot.py), [tests/test_web.py](../tests/test_web.py)
...
**File:** [tests/test_web.py](../tests/test_web.py)
...
**File:** [docker/obico-ml/Dockerfile](../docker/obico-ml/Dockerfile)
...
**File:** [sentinel/healthcheck.py](../sentinel/healthcheck.py)
...
**File:** [sentinel/db/repo.py](../sentinel/db/repo.py)
